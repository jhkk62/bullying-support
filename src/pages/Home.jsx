    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-brand-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          <p className="text-lg md:text-xl text-brand-50/90 mb-10 max-w-2xl mx-auto">
          ...
          <Link
            to="/forum"
            className="inline-block bg-white text-brand-700 font-semibold px-8 py-3 rounded-full shadow-lg hover:scale-105 transition-transform"
          >
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 grid md:grid-cols-3 gap-8">
        <PilarCard
          emoji="🔒"
          titulo="100% Anônimo"
          texto="Você participa sem precisar se identificar. Sua privacidade é prioridade."
        />
        <PilarCard
          emoji="💬"
          titulo="Comunidade Acolhedora"
          texto="Relate o que está sentindo e receba apoio de pessoas que já passaram por isso."
        />
        <PilarCard
          emoji="🎙️"
          titulo="Conversa em Tempo Real"
          texto="Entre em nossa sala de voz para conversar ao vivo quando precisar de companhia."
        />
      </section>
...
function PilarCard({ emoji, titulo, texto }) {
  return (
    <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow p-8 text-center border border-gray-100">
