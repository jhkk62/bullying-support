...
export default function Admin({ user, admin, ativo }) {
  ...
  async function entrarComoAdmin(e) {
    ...
    } catch { setErro("Código incorreto."); } finally { setEnviando(false); }
  }
    ...
    return (
      <div className="max-w-md mx-auto px-6 py-20 text-center">
        ...
        <form onSubmit={reativarSite} className="flex gap-2">
          <input type="password" value={codigo} onChange={(e) => setCodigo(e.target.value)} placeholder="senha..."
  ...
  if (admin) return <PainelAdmin onDesligar={tirarSiteDoAr} />;
